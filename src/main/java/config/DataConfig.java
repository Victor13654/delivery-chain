...
public class DataConfig {
    ...
    @Resource
    private Environment env; //get configuration data from configuration file

    @Bean//create a new database connection for every call
    ...
    @Bean//necessary for accessing multiple transactional resources within the same transaction
